...
def main():
    ...
    if uploaded_file is not None:
        ...
        generator = Generator(config['nz'], config['ngf'], config['nc'], 3, resolution=128).to(device)
        ...
        if st.button("Generate Image"):
            ...
            st.image(img, caption=f"Generated Image (Label: {label}, Noise Dim: {noise_dim}, Resolution: {resolution})",
